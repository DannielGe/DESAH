...
LABEL_DIR = 'H:/UnDataset/Flickr-25K/LAll/mirflickr25k-lall.mat'
TXT_DIR = 'H:/UnDataset/Flickr-25K/YAll/mirflickr25k-yall.mat'
IMG_DIR = 'H:/UnDataset/Flickr-25K/IAll/mirflickr25k-iall.mat'
...
#
#     train_dataset = MIRFlickr(train=True, transform=mir_train_transform)
#     test_dataset = MIRFlickr(train=False, database=False, transform=mir_test_transform)
#     database_dataset = MIRFlickr(train=False, database=True,transform=mir_test_transform)
